                        ...
                        for pron1 in words[vocs[i]]:
                            for pron2 in words[vocs[i + 1]]:
                                for pron3 in words[vocs[i + 2]]:
                                    ...
                                    # if not pron in tri_word:
                                    #     tri_word[pron] = {"words": [], "counts": []}
                                    # if not voc in tri_word[pron]["words"]:
                                    #     tri_word[pron]["words"].append(voc)
                                    #     tri_word[pron]["counts"].append(0)
                                    # tri_word[pron]["counts"][tri_word[pron]["words"].index(voc)] += 1
    # print(one_word)
    # print(two_word)
